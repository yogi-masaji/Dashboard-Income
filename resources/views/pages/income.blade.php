...
@section('content')
    ...
    <div id="templateContainer" class="d-none">
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <button class="nav-link" id="nav-weekly-line-tab" data-bs-toggle="tab" data-bs-target="#nav-weekly-line"
                        type="button" role="tab" aria-controls="nav-weekly-line" aria-selected="false">Line</button>
                </div>
            </nav>
        ...
        <div id="dataC">
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <button class="nav-link active" id="nav-monthly-tab" data-bs-toggle="tab" data-bs-target="#nav-monthly"
                        type="button" role="tab" aria-controls="nav-monthly" aria-selected="true">Bar</button>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    const rows = [{
                            type: 'Car',
                            thisWeek: thisWeek.carincome,
                            lastWeek: lastWeek.carincome
                        },
                        {
                            type: 'Motorbike',
                            thisWeek: thisWeek.motorbikeincome,
                            lastWeek: lastWeek.motorbikeincome
                        },
                        {
                            type: 'Truck',
                            thisWeek: thisWeek.truckincome,
                            lastWeek: lastWeek.truckincome
                        },
                        {
                            type: 'Taxi',
                            thisWeek: thisWeek.taxiincome,
                            lastWeek: lastWeek.taxiincome
                        },
                        {
                            type: 'lost ticket',
                            thisWeek: thisWeek.ticketincome,
                            lastWeek: lastWeek.ticketincome
                        },
                        {
                            type: 'Other',
                            thisWeek: thisWeek.otherincome,
                            lastWeek: lastWeek.otherincome
                        },
                    ];
                    ...
                    const formattedWeeklyRows = rows.map((item, index) => ({
                        no: index + 1,
                        vehicle: item.type,
                        this_week: formatRupiah(item.thisWeek),
                        last_week: formatRupiah(item.lastWeek)
                    }));
                    ...
                    $('#weeklyQuantity tfoot').html(`
                        <tr>
                            ...
                            <th id="totalLastWeek" style="font-size:12px;">${formatRupiah(lastWeek.vehicleincome)}</th>
                            <th id="totalThisWeek" style="font-size:12px;">${formatRupiah(thisWeek.vehicleincome)}</th>
                        </tr>
                        <tr>
                            <th colspan="2" style="text-align:left">All Sticker Income</th>
                            <th id="totalLastWeek" style="font-size:12px;">${formatRupiah(lastWeek.stickerincome)}</th>
                            <th id="totalThisWeek" style="font-size:12px;">${formatRupiah(thisWeek.stickerincome)}</th>
                        </tr>
                    `);
